/**
 * 22 Official 8th Schedule Indian Languages + English
 * Autonyms, English labels, text directions, and font requirements.
 */
export const LANGUAGES = [
  ...
  { code: 'mni', name: 'Manipuri', nativeName: 'ꯃꯤꯇꯩꯂꯣꯟ', dir: 'ltr', font: 'https://fonts.googleapis.com/css2?family=Noto+Sans+Meetei+Mayek:wght@400;600;700&display=swap' },
  ...
  { code: 'sat', name: 'Santali', nativeName: 'ᱥᱟᱱᱛᱟᱲᱤ', dir: 'ltr', font: 'https://fonts.googleapis.com/css2?family=Noto+Sans+Ol+Chiki:wght@400;600;700&display=swap' },
...
export const RTL_LANGUAGES = ['ks', 'sd', 'ur'];
